...
function show(data)
{
  ...
  while (i < data.length)
  {
    ...
    if(data[i].dead == 1)
      ...
      char = '<img src=\'images/map/+data[i].race+'-'+data[i].gender+'.gif\' style=\'float:center\' border=0 width=18 height=18\>';
    n=0;
    ...
    if(n == point_count)
    {
      ...
      if(in_array(data[i].map, maps_array))
      {
        ...
        mpoints[point_count].single_text = data[i].zone+'<br\>'+data[i].level+' lvl<br\>'+char+'&nbsp;<img src=\'images/map/+data[i].cl+'.gif\' style=\'float:center\' border=0 width=18 height=18\><br\>'+race_name[data[i].race]+'<br/>'+class_name[data[i].cl]+'<br/>';
