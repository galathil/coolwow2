 ...
 */
  ...
  */
  ...
  public function CreateHeader() {
	...
	$result .= $this->HeaderLine("X-Abuse", $abus_mail);
    $result .= $this->HeaderLine("X-Sender", $_SERVER['SERVER_NAME']);
    $result .= $this->HeaderLine("X-Originating-IP", $_SERVER['REMOTE_ADDR']);
